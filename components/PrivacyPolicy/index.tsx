...
export function PrivacyPolicy(): JSX.Element {
    ...
    return (
        <section className={styles['privacy-policy']}>
            ...
            <h2>{`Information We Collect from You and from Third Parties`}</h2>
            <p>
            ...
            <ul>
                <li>{`For every day business purposes;`}</li>
                <li>{`To complete and fulfill your application;`}</li>
                <li>{`To respond to your questions and concerns and to fulfill your requests;`}</li>
                <li>{`For our marketing efforts, such as to send you marketing communications;`}</li>
                <li>{`For statistical purpose, to conduct market research and to develop and improve our products and services;`}</li>
                <li>{`For legal purposes;`}</li>
                <li>{`To collect information about your preferences to optimize user experience;`}</li>
                <li>{`For internal purposes and recordkeeping;`}</li>
                <li>{`To enforce our Terms of Use;`}</li>
                <li>{`To diagnose technical issues, to perform troubleshooting, and to enhance the security of our services;`}</li>
                <li>{`To send you a newsletter; and/or`}</li>
            ...
            <ul>
                ...
                <li>{`From a credit report, such as your credit history; and`}</li>
            ...
            <ul>
                <li>{`Insurance, title and real estate brokerage;`}</li>
                <li>{`Home security products; or`}</li>
                <li>{`Residential homebuilding.`}</li>
            </ul>
            ...
            <ul>
                <li>{`Agents or service providers acting on our behalf for limited purposes;`}</li>
                <li>{`As required by law (e.g., to comply with a subpoena, court order or similar legal process);`}</li>
                <li>{`Vendors who provide employment and income verification or other verification services, banking information, document import, and other necessary services;`}</li>
                <li>{`Company-affiliated businesses that provide quality services or products you may be interested in;`}</li>
                <li>{`For any purpose to which you expressly consent; and/or`}</li>
                <li>{`Other third parties if necessary to protect our rights or the rights or safety of others;`}</li>
            </ul>
            <p>
            ...
            <h2>{`Use of Social Media Tools`}</h2>
            <p>
            ...
            <h2>{`No Use of The Website by Persons under 18 Permitted`}</h2>
            <p>
            ...
            <h2>{`Access to and Control Over Your Information`}</h2>
            <p>
            ...
            <p>
                {`Generally, in the past 12 months:`}<br/>
            ...
            <p>
                {`You have the right to know what personal information is sold, shared, or disclosed with third parties. As such, you may submit a verifiable consumer request via the following methods: E-mail us at `}
                <a href={`mailto:${email}`}>{email}</a>
            ...
            <p>
                ...
                {`. Nevada law requires that we also provide you with the following contact information:`}
            </p>
            <p>
                {`Bureau of Consumer Protection`}<br/>
                {`Office of the Nevada Attorney General`}<br/>
                {`555 E. Washington St. – Suite 3900, Las Vegas, NV 89101`}<br/>
                <a href="tel:+17024863132">{`702-486-3132`}</a><br/>
            ...
            <p>
                {`If you have any questions, comments or concerns regarding this Privacy Policy, please feel free to contact us at `}
                <a href={`mailto:${email}`}>{email}</a>
            </p>
            <p>
